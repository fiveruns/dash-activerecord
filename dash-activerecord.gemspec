...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "VERSION.yml", "lib/fiveruns", "lib/fiveruns/dash", "lib/fiveruns/dash/activerecord.rb", "lib/fiveruns/dash/recipes", "lib/fiveruns/dash/recipes/activerecord.rb", "lib/fiveruns-dash-activerecord.rb", "test/activerecord_test.rb", "test/test_helper.rb"]
  s.has_rdoc = true
